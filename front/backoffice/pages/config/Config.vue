                        ...
                        >
                            <widget :collapsed="true">
                                ...
                                <div slot="body">
                                    ...
                                    />
                                    <finput
                                        name="api.google.sitemap.enabled"
                                        :label="lang('l_google_enabled')"
                                        :form="state.sinks.creations.config"
                                        type="checkbox"
                                    />
                                    <finput
                                        name="api.google.sitemap.interval"
                                        :label="lang('l_google_interval')"
                                        :placeholder="lang('l_google_interval')"
                                        :is-required="true"
                                        :form="state.sinks.creations.config"
                                        type="number"
                                    />
