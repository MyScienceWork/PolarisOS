...
module.exports = {
    ...
    mounted() {
        ...
        this.$store.dispatch('search', {
            form: this.state.forms.rsink_query,
            path: APIRoutes.entity('query', 'POST', true),
            body: {
                projection: ['name', 'id'],
                size: 10000,
            },
    ...
    computed: {
        ...
        queries() {
            const content = this.mcontent(this.state.forms.rsink_query);
            return content || [];
        },
        readContent() {
