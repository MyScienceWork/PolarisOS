    ...
    data() {
        return {
            state: {
                ...
                paths: {
                    creations: {
                        publication: APIRoutes.entity('datacite', 'POST'), // Same path for PUT,
                        specs: 'publication_specs',
                    },
                    reads: {
                        publication: APIRoutes.entity('datacite', 'GET'),
                        typology: APIRoutes.entity('typology', 'POST', true),
                    },
                    validations: {
                        publication: APIRoutes.entity('datacite', 'VALIDATE', false, '0'),
                    },
                },
                forms: {
                    name: 'typology_form',
