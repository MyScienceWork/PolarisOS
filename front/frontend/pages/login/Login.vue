...
<div class="hero-body">
    <div class="container has-text-centered">
        <div class="column is-4 is-offset-4">
                ...
                <form>
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <div class="control">
                                    <input class="input is-large" :placeholder="lang('b_your_email')" autofocus="" type="email" v-model="state.email">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <div class="control">
                                    <input class="input is-large" :placeholder="lang('b_your_password')" type="password" v-model="state.password">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <a class="has-text-grey" href="../">{{lang('b_signup')}}</a> &nbsp;·&nbsp;
